...
<head>
    ...
    <style type="text/css">
        *{margin: 0px;padding: 0px;}
        ...
        #successful{z-index:9999;width: 300px;height: 200px;border: 0px solid silver;position: fixed;left: 40%;bottom: 50%;background:#6DA0E3;display: none;}
    ...
    var vm=new Vue({
        ...
        methods:{
            ...
            thisAjax(){
                ...
                axios.post("http://localhost:8080/MonkeyDocsStruts_war_exploded/business/userLogon.action",{userName:usernameData,password:passwordData,tel:phoneData,email:emailData}).then(
                    res=>
                {
                    console.log(res);
            ...
            flag (){
                ...
                //性别
                if(this.userInfo.sex==''){this.tiShi.tishi9='请选择性别';this.isReturn=true;}
                //同意协议
